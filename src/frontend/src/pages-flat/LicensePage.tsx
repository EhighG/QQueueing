      ...
      <div className="p-3 text-[1.5rem] ">
        ...
        <section className="text-[1rem]">
          ...
          <p className="my-2">
            ...
            &#39;&#39;SGPL&#39;&#39;이라고 칭합니다.)의 규정에 따라 배포될 수
            있다는 사항이 저작권자 또는 그에 준하는 정당한 권리를 갖고 있는 자에
            의해서 명시된 모든 종류의 소프트웨어 라이브러리와 컴퓨터 프로그램
            저작물(이하, &#39;&#39;프로그램&#39;&#39;이라고 칭합니다.)에 대해서
            동일하게 적용됩니다. &#39;&#39;피양도자&#39;&#39;란 SGPL의 규정에
            따라 프로그램을 양도받은 사람을 의미합니다. 용어 정의에 대한 법적
            해석이 필요한 경우 GNU 일반 공중허가서 3.0 버전의 용어 정의를
            활용합니다. (
          ...
          <p className="my-2">
            ...
            프로그램을 실행할 권리를 제한 없이 허용한다는 점을 분명하게
            명시하며, SGPL 적용 저작물을 실행함으로써 얻는 결과물은 그것의
            내용이 SGPL 적용 저작물을 구성하는 경우에 한해서 본 라이선스의
          ...
          <p className="my-2">
            ...
            확인해야하며, 등기우편 또는 내용증명 형식으로 송달하거나 해외 거주
            등에 따른 부득이한 경우에 한하여 이메일로 통지 의무를 다하여야
            합니다. 2) 관련 법률이 허용하는 한도 내에서 어떠한 형태의 보증도
            제공되지 않는다는 &#39;보증 부인&#39;을 제공 해야합니다. 3) 해당
            라이선스 사본을 소스코드와 함께 고지합니다. 4) 라이브러리 또는
          ...
          <p className="my-2">
            ...
            수정내용을 주석 형태나 문서로 고지합니다. 3) 제 3조 1항, 제 3조
          ...
          <p className="my-2">
            ...
            (2) SGPL 프로그램과 동일한 프로세서에서 동작하는 모듈 (3) SGPL
            프로그램과 링크로 연결한 라이브러리 (4) SGPL 프로그램을 상속한
            클래스를 의미합니다. 단, 같은 매체에 존재하지만 SGPL과 전혀 연동하지
            않는 프로그램, 별도의 프로그램으로서 Pipe, Socket, IPC, Command Line
          ...
          <p className="my-2">
            ...
            임베디드형 디바이스를 의미합니다. &#39;&#39;설치 정보&#39;&#39;란
            사용자가 소스코드를 빌드하여 다시 제품에 설치하는데 필요한 모든
            정보와 방법을 의미합니다. 1) 설치 정보의 제공이 불가능한 경우
            예외적으로 원저작자에게 서면을 통한 면책 승인 약정서를 받는 것으로
          ...
          <p className="my-2">
            ...
            프로그램을 사용한 저작물에도 모두 포함되며, 필요한 경우 삼성 청년 SW
            아카데미의 승인에 의하여만 갱신 대상에서 제외할 수 있습니다, 원
            저작자가 아닌 사람이 임의로 라이선스를 변경할 수 없습니다.
          </p>
          <p>
          ...
          <p className="my-2">
            ...
            배포자가 공동 또는 개별적으로 별도의 보증을 서면으로 제공할 때를
            제외하면, 특정한 목적에 대한 소스코드 또는 프로그램의 적합성이나
            상업성 여부에 대한 보증을 포함한 어떠한 형태의 보증도 명시적이나
            묵시적으로 설정되지 않은 &#39;&#39;있는 그대로의&#39;&#39; 상태로 이
            소스코드 또는 프로그램을 배포합니다. 소스코드 또는 프로그램의 실행에
          ...
          <p className="my-2">
            ...
            경우가 아니라면, 저작권자나 소스코드를 원래의 상태 또는 개작한
            상태로 제공한 배포자는 소스코드 또는 프로그램의 사용이나 비작동으로
            인해 발생된 손실이나 소스코드 또는 프로그램 자체의 손실에 대해
            책임지지 않습니다. 이러한 면책 조건은 사용자나 제3자가 소스코드 또는
            프로그램을 조작함으로써 발생된 손실이나 다른 소프트웨어와 소스코드
            또는 프로그램을 함께 동작시키는 것으로 인해서 발생된 데이터의 상실
            및 부정확한 산출 결과에만 국한되는 것이 아닙니다. 발생된 손실의
            일반성이나 특수성 뿐 아니라 원인의 우발성 및 필연성도 전혀 고려되지
            않습니다. 사용 허가서(이하, &#39;&#39;SGPL&#39;&#39;이라고
            칭합니다.)의 규정에 따라 배포될 수 있다는 사항이 저작권자 또는 그에
            준하는 정당한 권리를 갖고 있는 자에 의해서 명시된 모든 종류의
            소프트웨어 라이브러리와 컴퓨터 프로그램 저작물(이하,
            &#39;&#39;프로그램&#39;&#39;이라고 칭합니다.)에 대해서 동일하게
            적용됩니다. &#39;&#39;피양도자&#39;&#39;란 SGPL의 규정에 따라
            프로그램을 양도받은 사람을 의미합니다. 용어 정의에 대한 법적 해석이
            필요한 경우 GNU 일반 공중허가서 3.0 버전의 용어 정의를 활용합니다. (
            <a href="https://opensource.org/licenses/lgpl-3.0.html">
              https://opensource.org/licenses/lgpl-3.0.html
            </a>
            )
